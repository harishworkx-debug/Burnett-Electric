...
export const Route = createFileRoute("/electrician-vance-al")({
  ...
  component: () => (
    <LocationPageLayout
      ...
      benefits={[
        { title: "Residential Service", desc: "schedule an expert residential electrician for Vance home electrical needs." },
      ...
      faqs={[
        ...
        { q: "How can I schedule an electrician in Vance?", a: "Call us today to schedule an expert residential electrician." },
