...
export const Route = createFileRoute("/electrician-brookwood-al")({
  ...
  component: () => (
    <LocationPageLayout
      ...
      benefits={[
        { title: "Residential Service", desc: "Request help getting professional service for Brookwood home electrical needs." },
      ...
      faqs={[
        ...
        { q: "How can I get professional service in Brookwood?", a: "Call to request help hiring an expert residential electrician." },
