...
export const Route = createFileRoute("/wiring-upgrades-tuscaloosa-al")({
  head: () => ({
    meta: [
      { title: "Home Wiring & Panel Upgrades in Tuscaloosa, AL | Burnett Electric" },
  ...
  component: () => (
    <ServicePageLayout
      ...
      metaTitle="Home Wiring & Panel Upgrades in Tuscaloosa, AL"
      metaDescription="Expert electrical panel upgrades and home rewiring in Tuscaloosa, AL."
      h1="Wiring & Panel Upgrades in Tuscaloosa, AL"
      eyebrow="Modernize Your Power"
      hero={IMG.wiring}
      intro="Modern appliances, EVs, and home entertainment systems require more power than older electrical panels can safely provide. We specialize in bringing older Tuscaloosa homes up to code with safe, efficient wiring and high-capacity panel upgrades."
      benefits={[
        { title: "Service Panel Upgrades", desc: "Upgrade to a 200-amp or 400-amp service panel to handle modern electrical loads in your Tuscaloosa home." },
        ...
        { title: "Code Compliance", desc: "Ensure your home passes inspection when buying, selling, or renovating in Tuscaloosa, AL." },
      ]}
      problems={[
        "Constantly flipping tripped breakers in your main panel",
        "Needing adapters because you only have two-prong outlets",
        "Planning a major kitchen renovation or home addition in Tuscaloosa",
      ...
      faqs={[
        ...
        { q: "Will I lose power during a panel upgrade in Tuscaloosa?", a: "Yes, the power must be disconnected by the utility company during the installation. It typically takes a full day, and we coordinate this to minimize your downtime." },
